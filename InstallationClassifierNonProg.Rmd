...
#"best" model
model <- load_model_hdf5("Checkpoint_model_installation4.h5") #this is technically trained on Program tarps, but should be plenty generalizable to tarps in general.
...
#run loop
NProgram_Predicted_10_31<-lapply(raster.list
                      ,PredictRasterClips
...
NProgram_Predicted_10_31 <- as.data.frame(do.call(rbind,NProgram_Predicted_10_31))

NProgram_Predicted_10_31 <-left_join(Footprints,NProgram_Predicted_10_31, by="GlobalIDFootprint")%>%
                                    filter(!is.na(TarpProb))

st_write(NProgram_Predicted_10_31,"Building Data/NProgram_Predicted_10_31.shp")
