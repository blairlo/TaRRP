...
```{r}
FootprintsTarpRGBN<-ExtractRaster("C:/Users/blair/OneDrive/Desktop/PhD/Dissertation/@TemporaryRoofandRecoveryIndex/PlanetData/Monthly/01_2018",FootprintsTarp)
FootprintsRoofRGBN<-ExtractRaster("C:/Users/blair/OneDrive/Desktop/PhD/Dissertation/@TemporaryRoofandRecoveryIndex/PlanetData/Monthly/01_2018",FootprintsRoof)
```

### Compile Training set 
```{r}
#Label Outcomes
FootprintsTarpRGBN$Tarp<-1 
FootprintsRoofRGBN$Tarp<-0
