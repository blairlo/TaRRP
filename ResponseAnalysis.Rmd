...
MatchingSummary<- SummaryDat%>%
  ...
  dplyr::summarize(median(Val_sqf),
                   n())
...
Val_sqfDatasummaryNP<- NProgramTarpTime%>%
                dplyr::select(
                       FootprintArea,
                       VAPTOTAL,
                       Val_sqf,
...
stargazer(DatasummaryP,DatasummaryNP,
